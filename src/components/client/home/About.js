            ...
            <div className="col-md-4">
              <div className="card border-0">
                <div className="card-body">
                  ...
                  <p className="card-text fs-sm">Let us connect home owners and tenants directly to save time and thousands in a brokerage.</p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card border-0">
                <div className="card-body">
                  ...
                  <p className="card-text fs-sm">Avail our no advance payment service - use our service first and pay us later.</p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
