...
import { FillData } from '../__lib__/config/index';
                ...
                <div className="row justify-content-center pb-sm-2">
                    <div className="col-lg-11 col-xl-10">
                        ...
                        <div className="d-flex flex-column flex-sm-row bg-light rounded-3 p-4 px-md-5">
                            {
                                step!==0 && <a onClick={()=>setStep(--step)} className="btn btn-outline-primary btn-lg mb-3 mb-sm-0"><i className="fi-chevron-left fs-sm me-2" />Previous step</a>
                            }
                            {
                                step!==4 && <a onClick={()=>setStep(++step)} className="btn btn-primary btn-lg ms-sm-auto">Next step<i className="fi-chevron-right fs-sm ms-2" /></a>
